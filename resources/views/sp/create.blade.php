    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 font-bold" id="tambahModalLabel">TAMBAH DATA TINDAK LANJUT SP</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="post" action="{{ route('sp.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
                    @csrf
                    ...
                    <div class="max-w-xl">
                        ...
                        <x-select-input id="jenis_sp" name="jenis_sp" class="mt-1 block w-full" required>
                            <option value="">Pilih Jenis SP Siswa</option>
                            <option value="Sp-1" {{ old('jenis_sp') === 'Sp-1' ? 'selected' : '' }}>Sp-1</option>
                            <option value="SP-2" {{ old('jenis_sp') === 'SP-2' ? 'selected' : '' }}>SP-2</option>
                            <option value="SP-3" {{ old('jenis_sp') === 'SP-3' ? 'selected' : '' }}>SP-3</option>
                        </x-select-input>
                    </div>
