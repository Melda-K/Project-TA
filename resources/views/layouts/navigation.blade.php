            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('jadwalbk.index')" :active="request()->routeIs('jadwalbk.index') || request()->routeIs('jadwalbk.create')">
                        {{ __('DATA JADWAL BK SMK') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('jadwaljiwa.index')" :active="request()->routeIs('jadwaljiwa.index') || request()->routeIs('jadwaljiwa.create')">
                        {{ __('DATA JADWAL SPESIALIS KEJIWAAN') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('pengaduan.index')" :active="request()->routeIs('pengaduan.index') || request()->routeIs('pengaduan.create')">
                        {{ __('DATA PENGADUAN BK') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('pribasos.index')" :active="request()->routeIs('pribasos.index') || request()->routeIs('pribasos.create')">
                        {{ __('BK-PRIBADI, SOSIAL') }}
                    </x-nav-link>
                </div>
