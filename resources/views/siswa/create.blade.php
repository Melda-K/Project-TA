                ...
                <form method="post" action="{{ route('siswa.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
                    ...
                    <div class="max-w-xl">
                        ...
                        <x-select-input id="id_wali_kelas" name="id_wali_kelas" class="mt-1 block w-full" required>
                            ...
                            <option value="X" {{ old('id_wali_kelas') === 'X' ? 'selected' : '' }}>X ATPH</option>
                            <option value="X" {{ old('id_wali_kelas') === 'X' ? 'selected' : '' }}>X APHP</option>
                            <option value="X" {{ old('id_wali_kelas') === 'X' ? 'selected' : '' }}>X TKJ</option>
                            <option value="X" {{ old('id_wali_kelas') === 'X' ? 'selected' : '' }}>X TKRO</option>
                            <option value="X" {{ old('id_wali_kelas') === 'X' ? 'selected' : '' }}>X AKL</option>
                            <option value="X" {{ old('id_wali_kelas') === 'X' ? 'selected' : '' }}>X APAT</option>

                            <option value="XI" {{ old('id_wali_kelas') === 'XI' ? 'selected' : '' }}>XI ATPH</option>
                            <option value="XI" {{ old('id_wali_kelas') === 'XI' ? 'selected' : '' }}>XI APHP</option>
                            <option value="XI" {{ old('id_wali_kelas') === 'XI' ? 'selected' : '' }}>XI TKJ</option>
                            <option value="XI" {{ old('id_wali_kelas') === 'XI' ? 'selected' : '' }}>XI TKRO</option>
                            <option value="XI" {{ old('id_wali_kelas') === 'XI' ? 'selected' : '' }}>XI AKL</option>
                            <option value="XI" {{ old('id_wali_kelas') === 'XI' ? 'selected' : '' }}>XI APAT</option>

                            <option value="XII" {{ old('id_wali_kelas') === 'XII' ? 'selected' : '' }}>XII ATPH</option>
                            <option value="XII" {{ old('id_wali_kelas') === 'XII' ? 'selected' : '' }}>XII APHP</option>
                            <option value="XII" {{ old('id_wali_kelas') === 'XII' ? 'selected' : '' }}>XII TKJ</option>
                            <option value="XII" {{ old('id_wali_kelas') === 'XII' ? 'selected' : '' }}>XII TKRO</option>
                            <option value="XII" {{ old('id_wali_kelas') === 'XII' ? 'selected' : '' }}>XII AKL</option>
                            <option value="XII" {{ old('id_wali_kelas') === 'XII' ? 'selected' : '' }}>XII APAT</option>
                        </x-select-input>
                    </div>
                    <div class="max-w-xl">
